...
import dbStyles from "../scss/TOTDigitalBadge.module.scss";
import {
...
> {
  ...
  public onBadgeSelected(img: string): void {
    try {
      ...
      console.error("TOT_DigitalBadge_onBadgeSelected \n", JSON.stringify(error));
      this.setState({
  ...
  private async getAllBadgeImages() {
    try {
      ...
      console.error("TOT_DigitalBadge_getAllBadgeImages \n", JSON.stringify(error));
      this.setState({
                                ...
                                >
                                  {!this.state.hasAccepted && (
                                    <div className={dbStyles.divChild1}>
                                      ...
                                      <img
                                        src={require("../assets/TOTImages/AppBanner.png")}
